...
export default class HeaderResponsiveLayout extends Component {
  static displayName = 'HeaderResponsiveLayout';
    ...
    return (
      <Layout
        ...
        className={cx(`ice-design-custom-layout-${theme}`, {
          'ice-header-responsive-layout': true,
      ...
      >
        <Header
          className={cx({
            'ice-header-responsive-layout-header': true,
          })}
          theme={theme}
        ...
        <Layout.Section
          className={cx({
            'ice-header-responsive-layout-main-section': true,
            'ice-header-responsive-layout-main-section-open-drawer': this.state
              .openDrawer,
            'ice-header-responsive-layout-main-section-collapse': this.state
              .collapse,
          })}
        >
